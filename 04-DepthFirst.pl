...
/* Εδώ αφαίρεσα την διαγώνια κίνηση γιατί ήθελα να ψάχνει μόνο για*
 λύσεις με οριζόντιες και κάθετες κινήσεις, γιατί αλλιώς μου έβγαζε πάρα πολλές.*/	
...
/*
pathed_map(Map,[],Map).
pathed_map([[X|Rest]|Lines],Path,PM):-
*/


/*=====================TEST LIBRARY=====================*/

/*Κάπου εδώ πειραματίστηκα με το να τυπώσω το χάρτη με τέτοιο τρόπο ώστε να 
εμφανίζει και τη διαδρομή, αλλά μου φάνηκε πολύ δύσκολο και μετά από 
2 μέρες αποτυχία το  παράτησα γιατί τότε δούλευα. Δεν πρόλαβα να το ξαναπροσπαθήσω,
αλλά ίσως του ξαναδώσω μια ευκαιρία το καλοκαίρι, αν έχω χρόνο!*/
